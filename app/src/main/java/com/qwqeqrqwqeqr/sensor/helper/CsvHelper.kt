package com.qwqeqrqwqeqr.sensor.helper

import com.opencsv.CSVReader
import com.opencsv.CSVWriter
import com.qwqeqrqwqeqr.sensor.BuildConfig
import java.io.File
...
/*
 * Reference :  https://jhdroid.tistory.com/11
 */
...
class CsvHelper(private val filePath: String) {
    fun writeAllData(fileName: String, dataList: ArrayList<Array<String>>) {
        try {
            ...
            if (androidx.databinding.ktx.BuildConfig.DEBUG) {
                e.printStackTrace()
            }
        }
    }

    fun writeData(fileName: String, dataList: ArrayList<Array<String>>): String {
        try {
            FileWriter(File("$filePath/$fileName")).use { fw ->
